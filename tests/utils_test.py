...
from parsley.parse_to_object import _MESSAGE_PRIO, _MESSAGE_TYPE, _BOARD_TYPE_ID, _BOARD_INST_ID, _MESSAGE_SID
import utils as utilities

def test_create_msg_sid():
	sid = utilities.create_msg_sid_from_strings('HIGH', 'GENERAL_BOARD_STATUS', '0', 'RLCS_RELAY', 'GROUND')

	expected_bytes_len = (_MESSAGE_SID.length + 7) // 8 # rounds up to nearest byte

...
class TestCANMessage:
    ...
    def test_general_cmd(self, bit_str3):
        ...
        res = parsley.parse_fields(bit_str3, CAN_MSG.get_fields("GENERAL_CMD")[1:])
    ...
    def test_alt_arm_cmd(self, bit_str3):
        ...
        res = parsley.parse_fields(bit_str3, CAN_MSG.get_fields("ALT_ARM_CMD")[1:])
    ...
    def test_reset_cmd(self, bit_str3):
        ...
        res = parsley.parse_fields(bit_str3, CAN_MSG.get_fields("RESET_CMD")[1:])
    ...
    def test_debug_msg(self, bit_str3):
        ...
        res = parsley.parse_fields(bit_str3, CAN_MSG.get_fields("DEBUG_MSG")[1:])
        assert res["level"] == 6
    ...
    def test_debug_printf(self):
        ...
        res = parsley.parse_fields(bit_str, CAN_MSG.get_fields("DEBUG_PRINTF")[1:])
    ...
    def test_debug_radio_cmd(self):
        ...
        res = parsley.parse_fields(bit_str, CAN_MSG.get_fields("DEBUG_RADIO_CMD")[1:])
    ...
    def test_alt_arm_status(self, bit_str3):
        ...
        res = parsley.parse_fields(bit_str3, CAN_MSG.get_fields("ALT_ARM_STATUS")[1:])
    ...
    def test_sensor_temp(self, bit_str3):
        ...
        res = parsley.parse_fields(bit_str3, CAN_MSG.get_fields("SENSOR_TEMP")[1:])
    ...
    def test_sensor_altitude(self, bit_str3):
        ...
        res = parsley.parse_fields(bit_str3, CAN_MSG.get_fields("SENSOR_ALTITUDE")[1:])
    ...
    def test_sensor_acc(self, bit_str2):
        ...
        res = parsley.parse_fields(bit_str2, CAN_MSG.get_fields("SENSOR_ACC")[1:])
    ...
    def test_sensor_acc2(self, bit_str2):
        ...
        res = parsley.parse_fields(bit_str2, CAN_MSG.get_fields("SENSOR_ACC2")[1:])
    ...
    def test_sensor_gyro(self, bit_str2):
        ...
        res = parsley.parse_fields(bit_str2, CAN_MSG.get_fields("SENSOR_GYRO")[1:])
        assert res["x"] == tu.approx(3)
    ...
    def test_sensor_mag(self, bit_str2):
        ...
        res = parsley.parse_fields(bit_str2, CAN_MSG.get_fields("SENSOR_MAG")[1:])
    ...
    def test_sensor_analog(self, bit_str2):
        ...
        res = parsley.parse_fields(bit_str2, CAN_MSG.get_fields("SENSOR_ANALOG")[1:])
        assert res["sensor_id"] == "SENSOR_BARO"
    ...
    def test_gps_timestamp(self, bit_str3):
        ...
        res = parsley.parse_fields(bit_str3, CAN_MSG.get_fields("GPS_TIMESTAMP")[1:])
        assert res["hrs"] == 12
        assert res["mins"] == 23
        assert res["secs"] == 34
        assert res["dsecs"] == 45
    ...
    def test_gps_latitude(self, bit_str3):
        ...
        res = parsley.parse_fields(bit_str3, CAN_MSG.get_fields("GPS_LATITUDE")[1:])
        assert res["degs"] == 12
        assert res["mins"] == 23
    ...
    def test_gps_longitude(self, bit_str3):
        ...
        res = parsley.parse_fields(bit_str3, CAN_MSG.get_fields("GPS_LONGITUDE")[1:])
        assert res["degs"] == 12
        assert res["mins"] == 23
        assert res["dmins"] == 12345
    ...
    def test_gps_altitude(self, bit_str3):
        ...
        res = parsley.parse_fields(bit_str3, CAN_MSG.get_fields("GPS_ALTITUDE")[1:])
        assert res["altitude"] == 12345
    ...
    def test_gps_info(self, bit_str3):
        ...
        res = parsley.parse_fields(bit_str3, CAN_MSG.get_fields("GPS_INFO")[1:])
    ...
    def test_fill_lvl(self, bit_str3):
        ...
        res = parsley.parse_fields(bit_str3, CAN_MSG.get_fields("FILL_LVL")[1:])
        assert res["level"] == 9
    ...
    def test_radi_value(self, bit_str3):
        ...
        res = parsley.parse_fields(bit_str3, CAN_MSG.get_fields("RADI_VALUE")[1:])

...
class TestParsley:
    @pytest.fixture()
    def bit_str2(self, val=0):
        bit_str2 = BitString()
        bit_str2.push(*TIMESTAMP_2.encode(val))
        return bit_str2

    @pytest.fixture()
    def bit_str3(self, val=0):
        bit_str3 = BitString()
    ...
    def test_general_cmd(self, bit_str3):
        ...
        res = parsley.parse("GENERAL_CMD", bit_str3)
    ...
    def test_alt_arm_cmd(self, bit_str3):
        ...
        res = parsley.parse("ALT_ARM_CMD", bit_str3)
    ...
    def test_reset_cmd(self, bit_str3):
        ...
        res = parsley.parse("RESET_CMD", bit_str3)
    ...
    def test_debug_msg(self, bit_str3):
        ...
        res = parsley.parse("DEBUG_MSG", bit_str3)
        assert res["level"] == 6
    ...
    def test_debug_printf(self):
        bit_str3 = BitString()
        bit_str3.push(*ASCII("string", 64, optional=True).encode("ABCDEFGH"))
        res = parsley.parse("DEBUG_PRINTF", bit_str3)
        assert res["string"] == "ABCDEFGH"

    def test_debug_radio_cmd(self):
        bit_str3 = BitString()
        bit_str3.push(*ASCII("string", 64, optional=True).encode("RADIO"))
        res = parsley.parse("DEBUG_RADIO_CMD", bit_str3)
    ...
    def test_alt_arm_status(self, bit_str3):
        ...
        res = parsley.parse("ALT_ARM_STATUS", bit_str3)
    ...
    def test_board_status_nominal(self, bit_str3):
        ...
        res = parsley.parse("GENERAL_BOARD_STATUS", bit_str3)
    ...
    def test_sensor_temp(self, bit_str3):
        ...
        res = parsley.parse("SENSOR_TEMP", bit_str3)
    ...
    def test_sensor_altitude(self, bit_str3):
        ...
        res = parsley.parse("SENSOR_ALTITUDE", bit_str3)
    ...
    def test_sensor_acc(self, bit_str2):
        ...
        res = parsley.parse("SENSOR_ACC", bit_str2)
    ...
    def test_sensor_acc2(self, bit_str2):
        ...
        res = parsley.parse("SENSOR_ACC2", bit_str2)
    ...
    def test_sensor_gyro(self, bit_str2):
        ...
        res = parsley.parse("SENSOR_GYRO", bit_str2)
        assert res["x"] == tu.approx(3)
    ...
    def test_sensor_mag(self, bit_str2):
        ...
        res = parsley.parse("SENSOR_MAG", bit_str2)
    ...
    def test_sensor_analog(self, bit_str2):
        ...
        res = parsley.parse("SENSOR_ANALOG", bit_str2)
        assert res["sensor_id"] == "SENSOR_BARO"
    ...
    def test_gps_timestamp(self, bit_str3):
        ...
        res = parsley.parse("GPS_TIMESTAMP", bit_str3)
        assert res["hrs"] == 12
        assert res["mins"] == 23
        assert res["secs"] == 34
        assert res["dsecs"] == 45
    ...
    def test_gps_latitude(self, bit_str3):
        ...
        res = parsley.parse("GPS_LATITUDE", bit_str3)
        assert res["degs"] == 12
        assert res["mins"] == 23
    ...
    def test_gps_longitude(self, bit_str3):
        ...
        res = parsley.parse("GPS_LONGITUDE", bit_str3)
        assert res["degs"] == 12
        assert res["mins"] == 23
        assert res["dmins"] == 12345
    ...
    def test_gps_altitude(self, bit_str3):
        ...
        res = parsley.parse("GPS_ALTITUDE", bit_str3)
        assert res["altitude"] == 12345
    ...
    def test_gps_info(self, bit_str3):
        ...
        res = parsley.parse("GPS_INFO", bit_str3)
    ...
    def test_fill_lvl(self, bit_str3):
        ...
        res = parsley.parse("FILL_LVL", bit_str3)
        assert res["level"] == 9
    ...
    def test_radi_value(self, bit_str3):
        ...
        res = parsley.parse("RADI_VALUE", bit_str3)

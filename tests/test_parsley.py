"""
COMMENTING THIS OUT UNTIL WE FIGURE OUT HOW PARSLEY ERROR MESSAGSE ARE GOING TO LOOK LIKE
(or maybe I shouldn't be so strict with the assertions probably)
"""

...
class TestParsley:
    ...
    def test_parse_timestamp(self, timestamp):
        ...
        assert parsley_definitions._parse_timestamp(msg_data) == 12345

    def test_gen_cmd(self, timestamp):
        msg_data = timestamp(12345)
        msg_data += struct.pack(">b", mt.gen_cmd_hex["BUS_DOWN_WARNING"])
        res = parsley_definitions.parse_gen_cmd(msg_data)
    ...
    def test_actuator_cmd(self, timestamp):
        ...
        res = parsley_definitions.parse_actuator_cmd(msg_data)
    ...
    def test_arm_cmd(self, timestamp):
        ...
        res = parsley_definitions.parse_arm_cmd(msg_data)
    ...
    def test_parse_usb(self):
        msg_sid, msg_data = parsley_definitions.parse_usb_debug("$555:1,2,FF")
    ...
    def test_reset_cmd(self, timestamp):
        ...
        res = parsley_definitions.parse_reset_cmd(msg_data)

...
MESSAGES = {
    'GENERAL_BOARD_STATUS': [MESSAGE_PRIO, BOARD_TYPE_ID, BOARD_INST_ID, TIMESTAMP_2, Bitfield("general_board_status", 32, "E_NOMINAL", mt.general_board_status_offset), Bitfield('board_error_bitfield', 16, "E_NOMINAL", mt.board_specific_status_offset)],
    ...
    'SENSOR_IMU_Z':         [MESSAGE_PRIO, BOARD_TYPE_ID, BOARD_INST_ID, TIMESTAMP_2, Enum('imu_id', 8, mt.imu_id), Numeric('linear_accel', 16), Numeric('angular_velocity', 16)],

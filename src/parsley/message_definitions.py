...
MESSAGES = {
    ...
    'SENSOR_2D_ANALOG24':   [MESSAGE_PRIO, BOARD_TYPE_ID, BOARD_INST_ID, Enum('msg_metadata', 8, mt.dem_sensor_id), TIMESTAMP_2, Numeric('value_x', 24), Numeric('value_y', 24)],
    'SENSOR_3D_ANALOG16':   [MESSAGE_PRIO, BOARD_TYPE_ID, BOARD_INST_ID, Enum('msg_metadata', 8, mt.dem_sensor_id), TIMESTAMP_2, Numeric('value_x', 16), Numeric('value_y', 16), Numeric('value_z', 16)],

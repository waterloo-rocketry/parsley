...
MESSAGES = {
    'GENERAL_BOARD_STATUS': [MESSAGE_PRIO, BOARD_TYPE_ID, BOARD_INST_ID, MESSAGE_METADATA, TIMESTAMP_2, Bitfield('board_error_bitfield', 16, "E_NOMINAL", mt.board_error_bitfield_offset)],

...
MESSAGES = {
    ...
    'ACTUATOR_STATUS':      [MESSAGE_PRIO, BOARD_TYPE_ID, BOARD_INST_ID, MESSAGE_METADATA, TIMESTAMP_2, Enum('curr_state', 8, mt.actuator_state), Enum('cmd_state', 8, mt.actuator_state)],
    ...
    'SENSOR_DEM_ANALOG16':  [MESSAGE_PRIO, BOARD_TYPE_ID, BOARD_INST_ID, MESSAGE_METADATA, TIMESTAMP_2, Numeric('value_x', 16), Numeric('value_y', 16), Numeric('value_z', 16)],
    ...
    'GPS_ALTITUDE':         [MESSAGE_PRIO, BOARD_TYPE_ID, BOARD_INST_ID, MESSAGE_METADATA, TIMESTAMP_2, Numeric('altitude', 16), Numeric('daltitude', 8), ASCII('unit', 8)],

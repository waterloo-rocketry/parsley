...
msg_type = {
    ...
    'STREAM_DATA':          0x014,
    'STREAM_RETRY':         0x015,
    'TELEMETRY_INFO':       0x016,
    'CANARD_FIRMWARE_ERROR':0x017,
    'LEDS_ON':              0x018,
    'LEDS_OFF':             0x019,
}
...
analog_sensor_id = {
    ...
    'SENSOR_PT_CHANNEL_6':             0x11,
    'SENSOR_PT_CHANNEL_7':             0x12,
    'SENSOR_PT_CHANNEL_8':             0x13,
    'SENSOR_PT_CHANNEL_9':             0x14,
    'SENSOR_PT_CHANNEL_10':            0x15,
    'SENSOR_HALL_CHANNEL_1':           0x16,
    'SENSOR_HALL_CHANNEL_2':           0x17,
    'SENSOR_HALL_CHANNEL_3':           0x18,
    'SENSOR_RA_BATT_VOLT_1':           0x19,
    'SENSOR_RA_BATT_VOLT_2':           0x1A,
    'SENSOR_RA_BATT_CURR_1':           0x1B,
    'SENSOR_RA_BATT_CURR_2':           0x1C,
    'SENSOR_RA_MAG_VOLT_1':            0x1D,
    'SENSOR_RA_MAG_VOLT_2':            0x1E,
    'SENSOR_FPS':                      0x1F,
    'SENSOR_PAYLOAD_LIM_1':            0x20,
    'SENSOR_PAYLOAD_LIM_2':            0x21,
    'SENSOR_PAYLOAD_SERVO_DIRECTION':  0x22,
    'SENSOR_PAYLOAD_INFRARED':         0x23,
    'SENSOR_INJECTOR_BOARD_TEMP_1':    0x24,
    'SENSOR_INJECTOR_BOARD_TEMP_2':    0x25,
    'SENSOR_INJECTOR_BOARD_TEMP_3':    0x26,
    ...
    'SENSOR_LOG_WRITTEN_SIZE':         0x2D,
    'SENSOR_SD_LOG_FILE_NAME':         0x2E,
    'SENSOR_SD_USED':                  0x2F,
    'SENSOR_SD_FREE':                  0x30,
    'SENSOR_FLASH_LOG_FILE_NAME':      0x31,
    'SENSOR_FLASH_USED':               0x32,
    'SENSOR_FLASH_FREE':               0x33,
    'SENSOR_CANARD_CTRL_CMD_ANGLE':    0x34,
    'SENSOR_CANARD_CTRL_COEFF_LIFT':   0x35,
    'SENSOR_CANARD_MTI630_BARO_0':     0x36,
    'SENSOR_CANARD_MTI630_BARO_1':     0x37,
    'SENSOR_CANARD_MTI630_EST_ALT':    0x38,
    'SENSOR_CANARD_ADXRS649_GYRO':     0x39,
    'SENSOR_CANARD_SERVO_ANGLE':       0x3A,
    'SENSOR_CANARD_SERVO_CURR':        0x3B,
    'SENSOR_CANARD_SERVO_TEMP':        0x3C,
    'SENSOR_PAYLOAD_SENSOR_CURR_READING':0x3D,
    'SENSOR_ALTITUDE':                 0x3E,
}

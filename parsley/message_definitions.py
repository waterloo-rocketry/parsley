...
MESSAGES = {
    'GENERAL_BOARD_STATUS': [MESSAGE_PRIO, BOARD_TYPE_ID, BOARD_INST_ID, TIMESTAMP_2, Bitfield(name="general_board_status", default="E_NOMINAL", length=8, width=8, map_name_offset=mt.general_board_status), Numeric('general_error_bitfield', 32), Numeric('board_error_bitfield', 16)],

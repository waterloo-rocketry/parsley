...
MESSAGES = {
    ...
    'SENSOR_IMU_X':         [MESSAGE_PRIO, BOARD_TYPE_ID, BOARD_INST_ID, TIMESTAMP_2, Enum('imu_id', 8, mt.imu_id), Numeric('linear_accel', 16, scale=8/2**16, unit='m/s²', signed=True), Numeric('angular_velocity', 166, scale=2000/2**16, unit='°/s', signed=True)],
    'SENSOR_IMU_Y':         [MESSAGE_PRIO, BOARD_TYPE_ID, BOARD_INST_ID, TIMESTAMP_2, Enum('imu_id', 8, mt.imu_id), Numeric('linear_accel', 16, scale=8/2**16, unit='m/s²', signed=True), Numeric('angular_velocity', 166, scale=2000/2**16, unit='°/s', signed=True)],
    'SENSOR_IMU_Z':         [MESSAGE_PRIO, BOARD_TYPE_ID, BOARD_INST_ID, TIMESTAMP_2, Enum('imu_id', 8, mt.imu_id), Numeric('linear_accel', 16, scale=8/2**16, unit='m/s²', signed=True), Numeric('angular_velocity', 166, scale=2000/2**16, unit='°/s', signed=True)],
